...
- Numéro d'équipe : 3.1
- Nom de la base de données : MusiquePT2_K
...
Une application de gestion de discothèque. Permet d'emprunter, de rendre des albums ainsi que d'administrer la base de données.
